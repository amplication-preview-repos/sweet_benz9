...
import { TokenizationListRelationFilter } from "../../tokenization/base/TokenizationListRelationFilter";
...
class ModelWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TokenizationListRelationFilter,
  })
  @ValidateNested()
  @Type(() => TokenizationListRelationFilter)
  @IsOptional()
  @Field(() => TokenizationListRelationFilter, {
    nullable: true,
  })
